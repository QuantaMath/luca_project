...
Prerequisites
System Dependencies: Follow the official Tauri v2 prerequisites guide for your operating system.

Node.js: Ensure you have Node.js (LTS version recommended) and npm installed.

Diesel CLI: Install the command-line tool for interacting with the database:
...
Wait for the app to launch, then open a second terminal.
